...
public class CPU {
    ...
    public CPU(int productid, String brand, String processorserie, String processormodel, String socket, int clockspeed, int cores, String integradedgraphics, int tdp, String releasedate) {
